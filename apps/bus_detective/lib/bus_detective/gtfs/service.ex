defmodule BusDetective.GTFS.Service do
  ...
  def changeset(service, attrs) do
    service
    |> cast(attrs, [:agency_id, :remote_id, :monday, :tuesday, :wednesday, :thursday, :friday, :saturday, :sunday, :start_date, :end_date])
    |> validate_required([:agency_id, :remote_id, :monday, :tuesday, :wednesday, :thursday, :friday, :saturday, :sunday, :start_date, :end_date])
  end
end
